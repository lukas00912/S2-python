...
def cercle():
    canvas.create_oval(100,100,10,10, width=2, fill="blue", outline=COULEUR)

def carre():
    canvas.create_rectangle(100, 100, 30, 30, fill="red", outline=COULEUR)

def croix():
    canvas.create_line((150,160),(60,50), fill=COULEUR)
    canvas.create_line((50,60),(160,150), fill=COULEUR)
